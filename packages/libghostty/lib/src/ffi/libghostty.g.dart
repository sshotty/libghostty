...
Result ghostty_color_parse(
  ...
  int len,
  ffi.Pointer<ColorRgb> out,
) => Result.fromValue(_ghostty_color_parse(value, len, out));
...
Result ghostty_color_parse_x11(
  ...
  int len,
  ffi.Pointer<ColorRgb> out,
) => Result.fromValue(_ghostty_color_parse_x11(name, len, out));
...
Result ghostty_render_state_begin_update(
  RenderState state,
  Terminal terminal,
) => Result.fromValue(_ghostty_render_state_begin_update(state, terminal));
...
Result ghostty_render_state_end_update(RenderState state) =>
    Result.fromValue(_ghostty_render_state_end_update(state));
